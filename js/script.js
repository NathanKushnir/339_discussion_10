...
// Question 1
document.querySelector("#host-name").textContent = 'Nathan';
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    instructionButton.addEventListener("click", function () {
        for (let i = 0; i < instructions.length; i++) {
            instructions[i].classList.toggle("hidden");
        }

        if (instructionButton.textContent === "Hide Instructions") {
...
const usernamealert = document.getElementById('username_alert');
